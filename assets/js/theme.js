...
(function ($) {
   ...
   // ============================================================================
	...
	// Append button
	var $tt_demo_btn = '<a href="https://pinksale.finance" class="tt-demo-btn" target="_blank" rel="noopener"><div class="tt-demo-btn-img"><img src="https://stuff.themetorium.net/img/envato-logo-white.png" alt="Join Presale!"></div><div class="tt-demo-btn-text">On<br> Pinksale!</div></a>';
