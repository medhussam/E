...
(function ($) {
   ...
   // ========================================
	...
	// Append button
	var $tt_demo_btn = '<a href="https://pancakeswap.finance/" class="tt-demo-btn" target="_blank" rel="noopener"><div class="tt-demo-btn-img"><img src="assets/img/pancakeswap-cake-logo.png" ></div><div class="tt-demo-btn-text">Buy On<br> Pancakeswap!</div></a>';
